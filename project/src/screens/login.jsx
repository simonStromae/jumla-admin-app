    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: 'auto', position: 'relative', zIndex: 2 }}>
          <div className="route-pill" style={{
            ...
            <span>DOUALA</span>
            <I.Plane style={{color:'#F5A524'}} />
            <span>MONTRÉAL</span>
          </div>
          <h1 style={{
            fontSize: 44, fontWeight: 700, letterSpacing: '-.025em',
          ...
          <p style={{
            fontSize: 14.5, color: 'rgba(255,255,255,.6)',
            marginTop: 18, marginBottom: 0, maxWidth: 420, lineHeight: 1.55,
          }}>
            Plateforme opérationnelle pour gérer vos cargaisons, vos bordereaux et vos paiements
            depuis l'Afrique vers le Canada.
          </p>

          {/* Mini KPIs */}
          <div style={{ display: 'flex', gap: 32, marginTop: 36, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,.08)' }}>
            {[
              { k: '4', l: 'Routes actives' },
              { k: '22', l: 'Cargaisons / an' },
              { k: '312', l: 'Clients fidèles' },
            ].map((s, i) => (
              <div key={i}>
      ...
      <div style={{
        ...
        <div style={{ margin: 'auto 0', maxWidth: 380, width: '100%', alignSelf: 'center' }}>
          ...
          <p style={{ color: 'var(--ink-400)', fontSize: 13.5, marginTop: 6 }}>
            Accédez à votre espace opérations.
          </p>
          ...
          <div style={{ marginTop: 32, padding: 14, background: 'var(--bg-soft)', border: '1px solid var(--border-soft)', borderRadius: 10, display:'flex', gap:10 }}>
            ...
            <div style={{fontSize:12, color:'var(--ink-500)', lineHeight:1.45}}>
              <strong style={{color:'var(--ink-700)'}}>Accès réservé.</strong> Cette plateforme est destinée
              aux agents et administrateurs Zendit. Pour un suivi de colis client, voir
              <span style={{color:'var(--brand-600)', fontWeight:600, marginLeft:3, cursor:'pointer'}}>track.zendit.cargo</span>.
            </div>
          </div>
        </div>
