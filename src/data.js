...
export const STATUS = {
  ...
  payment: {
    ...
    'unpaid':  { label: 'En cours', en: 'Pending',   cls: 'warn'    },
    'pending': { label: 'En cours', en: 'Pending',   cls: 'warn'    },
    'ann':     { label: 'Annulé',   en: 'Cancelled', cls: 'neutral' },
  },
  parcel: {
    enr: { label: 'Enregistré',      cls: 'neutral' },
    rec: { label: 'Reçu entrepôt',   cls: 'info'    },
    pre: { label: 'Vérifié',         cls: 'info'    },
    exp: { label: 'Expédié',         cls: 'brand'   },
    tra: { label: 'En transit',      cls: 'warn'    },
    apd: { label: 'Arrivée pays',    cls: 'ok'      },
    dou: { label: 'En douane',       cls: 'warn'    },
    ins: { label: 'Inspection',      cls: 'warn'    },
    ret: { label: 'Retenu',          cls: 'bad'     },
    lib: { label: 'Libéré',          cls: 'ok'      },
    ard: { label: 'Entrepôt dest.',  cls: 'ok'      },
    ver: { label: 'Vérification',    cls: 'info'    },
    pdl: { label: 'Prêt livraison',  cls: 'info'    },
    liv: { label: 'En livraison',    cls: 'brand'   },
    ok:  { label: 'Livré',           cls: 'ok'      },
    adr: { label: 'Adresse incompl.', cls: 'bad'   },
    tdl: { label: 'Tentative livr.', cls: 'warn'    },
    rte: { label: 'Retour entrepôt', cls: 'warn'    },
    dom: { label: 'Endommagé',       cls: 'bad'     },
    cla: { label: 'Réclamation',     cls: 'bad'     },
    ann: { label: 'Annulé',          cls: 'neutral' },
  },
};
