...
export default function MessagingScreen({ onNav }) {
  const [selected, setSelected] = useState(['r1', 'r3', 'r4']);
  const [template, setTemplate] = useState('arrival');
  const [body, setBody] = useState(`Bonjour {first_name} 👋

Votre colis ({parcel_code}) de la cargaison {campaign_code} vient d'arriver à Montréal.
      ...
      <div className="page__head">
        ...
        <div className="page__actions">
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 12px', background: 'var(--ok-50)', border: '1px solid var(--ok-100)', borderRadius: 8 }}>
            <span style={{ width: 8, height: 8, borderRadius: 999, background: 'var(--ok-500)', boxShadow: '0 0 0 4px rgba(16, 185, 129, .2)' }} />
        ...
        <div className="card" style={{ display: 'flex', flexDirection: 'column', maxHeight: 'calc(100vh - 200px)' }}>
          <div style={{ padding: 14, borderBottom: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              ...
              <button className="btn btn--soft btn--sm" style={{ flex: 1, justifyContent: 'center' }}>Impayés</button>
              ...
              return (
                <label key={r.id} style={{
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontSize: 10.5, color: st.color, fontWeight: 600 }}>{st.icon} {st.lbl}</div>
                  </div>
          ...
          <div className="card" style={{ marginBottom: 14 }}>
            <div style={{ padding: '14px 16px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: 'var(--ink-400)' }}>Personnalisez et utilisez des variables pour chaque client</div>
              </div>
              ...
              <div style={{ background: '#E4DDD3', padding: 16, display: 'flex', flexDirection: 'column', gap: 8, minHeight: 360 }}>
                ...
                <div style={{ alignSelf: 'flex-start', maxWidth: '92%', background: 'white', borderRadius: '10px 10px 10px 2px', padding: '8px 10px', boxShadow: '0 1px 1px rgba(0,0,0,.08)', fontSize: 12, lineHeight: 1.45, whiteSpace: 'pre-wrap' }}>
                  {body
                    ...
                    .replace('{campaign_code}', 'DLA-YUL-APR-02')
