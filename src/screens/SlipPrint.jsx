...
export default function SlipPrintScreen({ code = 'BL-2604-01', onNav }) {
  return (
    <div style={{ background: '#E5E7EB', minHeight: '100vh', padding: '24px 0', fontFamily: 'var(--ff-sans)' }}>
      ...
      <div className="no-print" style={{
        ...
        <button className="btn btn--ghost btn--sm" onClick={() => onNav('/slip/' + code)}>
          <I.ArrowLeft />Retour
        </button>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 20, marginTop: 18, marginBottom: 20, alignItems: 'start' }}>
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontFamily: 'var(--ff-mono)', fontSize: 18, fontWeight: 700 }}>{code}</div>
          </div>
        </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #D1D5DB', fontSize: 12 }}>
          ...
          <tbody>
            {[
              ...
              { n: 4, name: 'Carton — produits cosmétiques',    packs: 1, pieces: 12, st: '⚠ Manquant', note: '2 flacons manquants' },
              { n: 5, name: 'Sachet — bijoux fantaisie',        packs: 1, pieces: 6,  st: '＋ En plus',  note: '1 article supplémentaire' },
            ].map(r => (
              <tr key={r.n}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 16, marginTop: 20 }}>
          <div style={{ border: '1px solid #D1D5DB', borderRadius: 4, padding: 12 }}>
            ...
            <div style={{ fontSize: 11.5, color: '#374151', lineHeight: 1.6, minHeight: 60 }}>
              ...
              Deux flacons cosmétiques manquants signalés — note transmise à l'expéditeur via WhatsApp.
            </div>
          </div>
          <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #D1D5DB', fontSize: 12 }}>
            <tbody>
              ...
              <tr style={{ background: '#0F172A', color: 'white', fontWeight: 700 }}>
                ...
                <td style={{ ...cell, color: 'white', textAlign: 'right', fontFamily: 'var(--ff-mono)', fontSize: 14, borderColor: '#0F172A' }}>329,00 CAD</td>
              </tr>
              <tr>
                <td colSpan={2} style={{ ...cell, fontSize: 11, color: '#059669', fontWeight: 600 }}>✓ Réglé · 26/04/2026 · Virement Interac</td>
              </tr>
            </tbody>
          </table>
        </div>
